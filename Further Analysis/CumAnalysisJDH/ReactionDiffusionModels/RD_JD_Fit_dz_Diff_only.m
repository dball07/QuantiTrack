function [FitPar, FitParSigma, FitSSR, Fit] = RD_JD_Fit_dz_Diff_only(Data, Par, Ini, parFlag, plotFlag)
...
fitfun = @(COEF) (RD_JD_Fun_dz_Diff_only(COEF, Par) - Data);
...
disp(['DeltaZ = ', num2str(FitPar(3),2), 'mum'])
disp('_________________________________________')
