function [Esp_Coef, Esp_Sigma, Esp_Fit] = ExpDecay_2Cmp_nlinfitRobust(data, k0s)
...
fitfun = @(COEF,tlist)ExpDecay_2Cmp_fun(COEF, tlist);
...
opts.TolFun = 10e-30;
opts.MaxIter = 1000;
[Esp_Coef, residuals,jacobian] = nlinfit(data(:,1),data(:,2),fitfun,COEF0,opts);
% run fitting routibe
