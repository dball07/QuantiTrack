...
TimeGap = 200; % delay between frames in milliseconds
...
TimePoints = 5; % How many delays to consider: N timepoints yield N-1 delays
...
D_Free_2State = [0.05 0.1]; % min/max Diffusion constant for Free state in 2-state model (units um^2/s)
D_Bound_2State = [0.0001 0.05]; % min/max Diffusion constant for Bound state in 2-state model (units um^2/s)
D_Free1_3State = [0.0001 0.1]; % min/max Diffusion constant #1 for Free state in 3-state model (units um^2/s)
...
if DataSet == 1 % Example DataSet 1: a single replicate of Halo-hCTCF at 134 Hz
    data_struct(1).path = [pwd filesep];%[pwd, filesep, 'Data', filesep, 'CTCF_134Hz_rep1', filesep];
    data_struct(1).workspaces = {'Spot-on_input_3617_pHalo-ER_E2_200ms_E2'};%{'U2OS_C32_Halo-CTCF_PA-JF646_1ms-633nm_134Hz_rep1_cell01', 'U2OS_C32_Halo-CTCF_PA-JF646_1ms-633nm_134Hz_rep1_cell02', 'U2OS_C32_Halo-CTCF_PA-JF646_1ms-633nm_134Hz_rep1_cell03', 'U2OS_C32_Halo-CTCF_PA-JF646_1ms-633nm_134Hz_rep1_cell04', 'U2OS_C32_Halo-CTCF_PA-JF646_1ms-633nm_134Hz_rep1_cell05'};
    data_struct(1).Include = [1]; %[1,2,3,4,5];
    SampleName = '3617 pHalo-ER; E2; 5 Hz; all';
