function [best_vals, best_ci, residuals, list_of_model_parameters] = ModelFitting_main(JumpProb, JumpProbCDF, NumberOfStates, FitLocErrorRange, FitIterations, D_Free_2State, D_Bound_2State, D_Free1_3State, D_Free2_3State, D_Bound_3State)
...
for iter=1:FitIterations
    ...
    ci  = calculate_ci_from_jacobian(J, values, residuals, ssq2, 0.05);
